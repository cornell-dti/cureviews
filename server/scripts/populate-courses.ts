...
import { ScrapingSubject, ScrapingClass } from './types.js';
import { Classes, Professors, Subjects } from '../src/db/schema.js';
import { extractProfessors } from './populate-professors.js';
